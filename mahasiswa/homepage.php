...
<nav class="navbar navbar-light bg-navy pt-5 px-5 pb-3">
    ...
    <div class="bg-navy">
        <div class="p-5 text-center text-white">
            <h1>Magang</h1>
            <p class="p-5 w-50 mx-auto">Fakultas Vokasi UB menerapkan magang sesuai dengan kebijakan Merdeka Belajar Kampus Merdeka (MBKM), dimana memberikan kesempatan kepada mahasiswa untuk belajar di luar kampus selama 2 semester dan dapat dikonversi 20 sks untuk setiap semester.</p>
